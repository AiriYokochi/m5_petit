// m5_atom_nyako.ino — にゃこ (ラベンダー #cab8d9)
...
// ===== にゃこ の色 =====
#define COLOR_NEUTRAL_BG  ((uint16_t)0xCDDB)  // #cab8d9 ラベンダー
#define COLOR_NEUTRAL_FG  TFT_BLACK
#define COLOR_HAPPY_BG    ((uint16_t)0xFDB8)  // #FFB6C1 薄ピンク白
#define COLOR_HAPPY_FG    TFT_BLACK
#define COLOR_ANGRY_BG    ((uint16_t)0x8010)  // #800080 深い紫
