// m5_atom_nyaru.ino — にゃる (ターコイズ #00afcc)
...
// ===== にゃる の色 =====
#define COLOR_NEUTRAL_BG  ((uint16_t)0x0579)  // #00afcc ターコイズ
#define COLOR_NEUTRAL_FG  TFT_NAVY
#define COLOR_HAPPY_BG    TFT_CYAN
#define COLOR_HAPPY_FG    TFT_NAVY
#define COLOR_ANGRY_BG    ((uint16_t)0x02AE)  // #005577 深いティール
